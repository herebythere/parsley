use crate::constants::{
    ATTRIBUTE, ATTRIBUTE_DECLARATION, ATTRIBUTE_DECLARATION_CLOSE, ATTRIBUTE_INJECTION,
    ATTRIBUTE_MAP_INJECTION, ATTRIBUTE_SETTER, ATTRIBUTE_VALUE, CLOSE_NODE_CLOSED,
    CLOSE_NODE_SLASH, CLOSE_NODE_SPACE, CLOSE_TAGNAME, DESCENDANT_INJECTION, ERROR,
    INDEPENDENT_NODE, INDEPENDENT_NODE_CLOSED, INITIAL, INJECTION, INJECTION_CONFIRMED,
    INJECTION_SPACE, NODE, NODE_CLOSED, NODE_SPACE, TAGNAME, TEXT,
};
