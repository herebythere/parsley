...
function increment(template: TemplateStringsArray, position: Position): Position | undefined {
  // template boundaries
...
function getChar(template: TemplateStringsArray, position: Position): string | undefined {
...
function incrementOrigin(template: TemplateStringsArray, vector: Vector): Vector | undefined {
  if (increment(template, vector.origin)) return vector;
};

function getText(template: TemplateStringsArray, vector: Vector): string | undefined {
